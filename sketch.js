...
function setup() {
  ...
  ground = createSprite(windowWidth / 2, height - 20, 400, 20);
  ...
  invisibleGround = createSprite(width / 2, height - 10, windowWidth, 10);
...
function draw() {
  ...
  drawSprites();
  text("Highest score:" + localStorage["HighestScore"], width - 220, height - 150);
}
